...
export default function ModalFilter() {
  ...
  const onChangeSelectDocumentType = (selecteddocumentType) => {
    setSelectedDocumentType(selecteddocumentType);
    setFormData({
      ...formData,
      document_type_id: selecteddocumentType ? selecteddocumentType.value : "",
    });
  };
  ...
  const getDocumentType = () => {
    axiosClient
      .get("/data-reference/document-types/search")
      .then(({ data }) => {
